...
const BookDetail = () => {
    ...
    const [data, setData] = useState<BookPost | null>(null);
    ...
    useEffect(()=>{
        ...
        const slug = pathname.split('/books/')[1];
        ...
        return (
            <article className="md:w-5xl md:h-134 bg-nier-100 mt-5 relative">
                ...
                <div className="py-4 pb-8 md:p-4 flex-col flex md:flex-row">
                    ...
                    <div className="md:ml-0 ml-5 absolute bottom-0 text-nier-text-dark text-sm md:text-base italic">{data.release_date} - {data.author}</div>
